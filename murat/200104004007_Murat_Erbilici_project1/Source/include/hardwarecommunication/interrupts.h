...
namespace myos
{
    namespace hardwarecommunication
    {
        ...
        public:
            ...
            myos::common::uint32_t syscallGetPID();
            bool syscallExit();
            common::uint32_t syscallFork(CPUState* cpu);
            common::uint32_t syscallExecve(void (*entrypoint)());
            bool syscallWaitPid(CPUState* cpu);
